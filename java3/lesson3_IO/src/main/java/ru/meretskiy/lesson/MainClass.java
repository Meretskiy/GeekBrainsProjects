...
public class MainClass {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        ObjectOutputStream oos1 = new ObjectOutputStream(new FileOutputStream("java3/dir/stud.ser"));
        ...
        ObjectInputStream ois1 = new ObjectInputStream(new FileInputStream("java3/dir/stud.ser"));
    ...
    private static void bufferExample() {
        File file = new File("java3/dir/1.txt");
